...
public class idkFunctioning extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // -----------------------------------------------------------------
        // PERFORMANCE IMPROVEMENT: BULK READS
        // This reduces data lag by reading all sensor data in one go.
        // -----------------------------------------------------------------
        ...
        while (opModeIsActive()) {
            ...
            // -------------------------------------------------------------
            // 2. FIELD-CENTRIC MECANUM DRIVE (WITH SQUARED INPUTS)
            // -------------------------------------------------------------
            // We square the inputs (input * input) to give fine precision
            // at low speeds while keeping max speed at 100%.
            // Math.copySign(a, b) returns magnitude of 'a' with sign of 'b'.
            // -------------------------------------------------------------
            ...
            // 5. TELEMETRY
            // -------------------------------------------------------------
            telemetry.addData("Mode",        "FIELD-CENTRIC (Responsive)");
